...
"""
This is the modification of logistic_sgd.py
Has to be tested!
...
class LinearRegression(object):
    ...
    and bias vector :math:`b`. Regression is done by calculating the value of the function which fits the best the training data.
    """
...
def sgd_optimization_linear_regression(learning_rate=0.13, n_epochs=1000,
    ...
    cost = predictor.loss_function(y)
    ...
    g_W = T.grad(cost=cost, wrt=predictor.W)
    g_b = T.grad(cost=cost, wrt=predictor.b)

    # specify how to update the parameters of the model as a list of
    # (variable, update expression) pairs.
    updates = [(predictor.W, predictor.W - learning_rate * g_W),
               (predictor.b, predictor.b - learning_rate * g_b)]
